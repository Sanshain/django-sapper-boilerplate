import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, v as validate_slots, a as space, e as element, t as text, q as query_selector_all, b as detach_dev, c as claim_space, f as claim_element, g as children, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.e3279d32.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			if (img.src !== (img_src_value = "{% static \"successkid.jpg\" %}")) attr_dev(img, "src", img_src_value);
			attr_dev(img, "class", "svelte-1kk9opm");
			add_location(img, file, 45, 1, 551);
			add_location(figcaption, file, 46, 1, 614);
			attr_dev(figure, "class", "svelte-1kk9opm");
			add_location(figure, file, 44, 0, 541);
			add_location(strong, file, 49, 3, 675);
			attr_dev(p, "class", "svelte-1kk9opm");
			add_location(p, file, 49, 0, 672);
		},
...
//# sourceMappingURL=index.59479fee.js.map
